...
\begin{center}
		%TODO Titel angeben
		{\textbf{\Huge \ifthenelse{\boolean{english}}{Title of the Thesis}{Titel der Arbeit}}}
		\vspace*{1cm}\\
		%TODO Art der Arbeit
		{\Large \ifthenelse{\boolean{english}}{Seminar Paper / Bachelor Thesis / Master Thesis}{Seminararbeit / Bachelorarbeit / Masterarbeit}}\\[1cm]
		{\Large \ifthenelse{\boolean{english}}{by}{von}}\\[1cm]
		%\vspace*{1cm}
		%TODO Name des Studenten
		{\huge Vorname Nachname}\\[0.5cm]
		...
		%TODO MatNr angeben
		{\Large \ifthenelse{\boolean{english}}{Matriculation Number}{Matrikelnummer}: 1234567}\\
		\vspace*{1.5cm}
...
\begin{tabular}[ht]{l c l}
  ...
  \ifthenelse{\boolean{english}}{Advisor}{Prüfer}: & \hfill  & *Titel Vor- und Nachname* \\
  %Referent/-in sind die Professoren, die die Arbeit bewerten.
  \ifthenelse{\boolean{english}}{Second Advisor}{Zweiter Prüfer}: & \hfill  & *Titel Vor- und Nachname* \\
  %TODO Betreuer/-in angeben
  \ifthenelse{\boolean{english}}{Supervisor}{Betreuer}: & \hfill  & *Titel Vor- und Nachname* \\
